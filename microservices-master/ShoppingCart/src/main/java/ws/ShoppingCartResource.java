...
public class ShoppingCartResource {
    ...
    public List<ShoppingCart> getAllShoppingCart() {return shoppingCartReposity.findAll(); }
    ...
    public void addProductToCart(@RequestBody ShoppingCart shoppingCart, @PathVariable int id) {
